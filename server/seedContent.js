...
const pageSeeds = {
  ...
  resume: [
    ...
    { category: "experience", title: "Frontend Developer Intern", text: "Techfusion Technologies - Navsari", items: ["Oct 2025 - Dec 2025 | React.js, JavaScript, HTML5, CSS3, React Router DOM"], order: 20 },
    { category: "experience", title: "Independent Learning - App Development", text: "Online Platforms", items: ["2026 - Present | Dart, Flutter, mini-projects, debugging, and problem-solving"], order: 21 },
    { category: "project", title: "Royal Palace Management System", order: 30 },
    { category: "project", title: "Class Throng", order: 31 },
    { category: "project", title: "Masala Mastery", order: 32 },
    { category: "project", title: "Music Streamer", order: 33 },
    { category: "project", title: "Coaching Management System", order: 34 },
    { category: "project", title: "Service Booking System", order: 35 },
    { category: "project", title: "Job Portal", order: 36 },
    { category: "project", title: "Hospital Management System", order: 37 },
    { category: "project", title: "EduHub Online Examination", order: 38 },
    { category: "skill", title: "Technical Skills", items: ["C", "PHP", "Python (Basics)", "JavaScript", "React.js", "HTML5", "CSS3", "Bootstrap", "Tailwind CSS", "ASP.NET (Basics)", "MySQL", "SQL Server", "MongoDB", "Git", "VS Code", "DBMS", "OOP", "Operating Systems", "Computer Networks"], order: 40 },
    { category: "link", title: "GitHub", url: "#", order: 50 },
    { category: "link", title: "LinkedIn", url: "#", order: 51 },
    { category: "link", title: "Email", url: "mailto:chetanpawar8125@gmail.com", order: 52 },
